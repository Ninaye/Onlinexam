	...
	<%@ include file="./menu.jsp"%>
  	...
  	<div class = "ui container" style = "width: 400px">
	    <div class="ui inverted segment" style = "opacity:0.7">
	      	...
	      	<form class="ui large form" action="questionAddServlet" method="post" >
				...
				<div class="two fields" style="text-align: center;padding-right: 40px;padding-top:5px">
					...
					<div class = "ui container" style = "height:30px">
						<input type="text" placeholder="试题题目" name="queTitle" id="queTitle"  style = "height:30px"/>
					</div>
				</div>
				...
				<div class="two fields" style="text-align: center;padding-right: 40px;padding-top:5px">
					...
					<div class = "ui container" style = "height:30px">
						<input type="text" placeholder="输入A选项内容" name="choiceA" id="choiceA"  style = "height:30px"/>
					</div>
				</div>
				<div class="two fields" style="text-align: center;padding-right: 40px;padding-top:5px">
					<div class = "ui container" style="padding: 6px;height:30px">
					...
					<div class = "ui container" style = "height:30px">
						<input type="text" placeholder="输入B选项内容" name="choiceB" id="choiceB" style = "height:30px"/>
					</div>
				</div>
				<div class="two fields" style="text-align: center;padding-right: 40px;padding-top:5px">
					<div class = "ui container" style="padding: 6px;height:30px">
					...
					<div class = "ui container" style = "height:30px">
						<input type="text" placeholder="输入C选项内容" name="choiceC" id="choiceC" style = "height:30px"/>
					</div>
				</div>
				<div class="two fields" style="text-align: center;padding-right: 40px;padding-top:5px">
					<div class = "ui container" style="padding: 6px;height:30px">
					...
					<div class = "ui container" style = "height:30px">
						<input type="text" placeholder="输入D选项内容" name="choiceD" id="choiceD" style = "height:30px"/>
					</div>
				</div>
				<div class="two fields" style="text-align: center;padding-right: 40px;padding-top:5px">
					<div class = "ui container" style="padding: 6px;height:30px">

...
<body>
  ...
  <div class = "ui container" style = "width: 500px">
    <div class="ui inverted segment" style = "opacity:0.7">
      ...
      <form class="ui large form" action="courseModifyServlet" method="post">
        <input type="hidden" name="courseId" id = "courseId" value = "${course.cid}"></input>
        <div class="two fields" style="text-align: center;padding-right: 45px;padding-top: 30px">
            <div class = "ui container" style="padding: 6px"><h3>输入课程名称</h3></div>
            <div class = "ui container"><input type="text" placeholder="${course.cname}" name="coursename" id="coursename"></div>
          </div>
          </br>

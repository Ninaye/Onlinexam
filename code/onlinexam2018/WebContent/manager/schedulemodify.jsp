	...
	<%@ include file="./menu.jsp"%>
  	...
  	<div class = "ui container" style = "width: 500px">
	    <div class="ui inverted segment" style = "opacity:0.7">
	      	...
	      	<form class="ui large form" action="scheduleModifyServlet" method="post">
	      		<input type = "hidden" name = "id" id = "id" value = "${tc.tcId}"/>
		            ...
		            <div class = "ui container">
		            	<select class = "ui fluid icon dropdown" name="course">
              				<c:forEach var="c" items="${course}">
								<c:choose>
									<c:when test="${tc.tcCourseId==c.cid}">
		        ...
		        <div class="two fields" style="text-align: center;padding-top: 10px;padding-right: 45px">
		            <div class = "ui container" style="padding: 6px">
		            	<h3>选择教师</h3>
		            </div>
		            <div class = "ui container">
		            	<select class = "ui fluid icon dropdown" name="teacher">
              				<c:forEach var="t" items="${teacher}">
                				<c:choose>
									<c:when test="${tc.tcTeacherId==t.tid}">
		            ...
		            <div class = "ui container">
		              	<select class = "ui fluid icon dropdown" name="stuClass">
              				<c:forEach var="sc" items="${stuclass}">
                				<c:choose>
									<c:when test="${tc.tcStuClassId==sc.scid}">
										<option value="${sc.scid}" selected = "selected">${sc.scname}</option>
									</c:when>
									<c:otherwise>

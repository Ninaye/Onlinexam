	...
	<%@ include file="./menu.jsp"%>
  	...
  	<div class = "ui container" style = "width: 650px">
	    <div class="ui inverted segment" style = "opacity:0.7">
	      	<form class="ui large form" action="studentModifyServlet" method="post">
	      		<input type="hidden" name="studentId" id="studentId" value = "${student.sid}"/>
	      		<div class="ui fluid">
					<div class = "ui container">
						<div style = "width: 220px;margin:0 auto;">
							<div class="two fields" style="text-align: center;padding-top: 30px">
								<div class = "ui container" style="padding: 6px">
									<h3>学生学号</h3>
								</div>
								<div class = "ui container" style = "padding-top:6px">
									<lable><h3>${student.sid}</h3></lable>
								</div>
		         			</div>
						</div>
					</div>
		        ...
		        <div class="four fields" style="text-align: center;padding-right: 40px;padding-top:10px">
					...
					<div class = "ui container">
						<input type="text" placeholder="所在学院" name="school" id="school" value = "${student.school}"/>
					</div>
					<div class = "ui container" style="padding: 6px">
						<h3>学生密码</h3>
					</div>
					<div class = "ui container">
						<input type="password" placeholder="学生密码" name="studentpwd" id="studentpwd" value = "${student.spwd}"/>
					</div>
				</div>
				...
				<div class="four fields" style="text-align: center;padding-right: 40px;padding-top:10px">
					...
					<div class = "ui container">
						<input type="text" placeholder="学生姓名" name="studentName" id="studentName" value = "${student.sname}"/>
					</div>
					<div class = "ui container" style="padding: 6px">
		            	<h3>选择班级</h3>
		            </div>
		            <div class = "ui container">
		            	<select class = "ui fluid icon dropdown" name="stuClass">
              				<c:forEach var="stuclass" items="${stuclassList}">
                				<c:choose>
                  					<c:when test="${stuclass.scid==student.classId}">
                   				 		<option value = "${stuclass.scid}" selected = "selected">${stuclass.scname}</option>
                  					</c:when>
                  					<c:otherwise>
				...
				<div class="four fields" style="text-align: center;padding-right: 40px;padding-top:10px">
					      		...
					      		<div class="ui radio checkbox">
					      			<c:choose>
										<c:when test="${student.sex=='男'}">
											<input name="sex" tabindex="0" checked = "checked" type="radio" value = "男">
					      		...
					      		<div class="ui radio checkbox">
					      			<c:choose>
										<c:when test="${student.sex=='女'}">
											<input name="sex" tabindex="0" checked = "checked" type="radio" value = "女">
					...
					<div class = "ui container" style = "width:175px">
						<input type="date" name="date" id="date" value = "${student.born}"/>
					</div>
				</div>
